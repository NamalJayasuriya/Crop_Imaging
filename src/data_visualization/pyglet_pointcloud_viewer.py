...
# #file_path = '/media/namal/Data/Phd/Datasets/realsense/g3_d415_L_24auf_test_300lsr_9.32am_15fps.bag'
...
# file_path = '/media/namal/Data/Phd/Datasets/realsense/R6_G4_L_14_9.bag'
...
#config.enable_stream(other_stream, other_format, fps)

pipeline_wrapper = rs.pipeline_wrapper(pipeline)
pipeline_profile = config.resolve(pipeline_wrapper)
device = pipeline_profile.get_device()
# profile = pipeline.start(config)
# device = profile.get_device().first_depth_sensor()
...
def run(dt):
    ...
    thr_filter.set_option(rs.option.max_distance, 2)
